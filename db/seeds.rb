...
grubb = Teacher.create(last_name: "grubb", grade_level: "first", years_of_experience: 6)
ian = Teacher.create(last_name: "ian", grade_level: "second", years_of_experience: 9)
tashawn = Teacher.create(last_name: "tashawn", grade_level: "third", years_of_experience: 3)
alicia = Teacher.create(last_name: "alicia", grade_level: "fourth", years_of_experience: 5)
justin = Teacher.create(last_name: "justin", grade_level: "fifth", years_of_experience: 1)
